...
public class SandboxListas
{
    ...
    {
        List<Integer> copy= new ArrayList<Integer>(listaEnteros);
        return copy;
    }
    ...
    {
    	List<String> copy =new LinkedList<String>(listaCadenas);
        return copy;
    }
    ...
    public void reiniciarArregloCadenas( List<Object> objetos )
    {
    	...
    	for(int i=0; i<objetos.size(); i++) {
    		...
    		String nueva_cadena= elemento.toString();
    		listaCadenas.add(nueva_cadena);
    	}
    ...
    {
    	long contador= listaEnteros.stream().filter(s->s.equals(valor)).count();
        return (int) contador;
    }
    ...
    {
    	long contador= listaCadenas.stream().filter(s->s.equalsIgnoreCase(cadena)).count();
    ...
    public int contarEnterosRepetidos( )
    {
    	...
    	for (Integer valor: conteo.values()) {
    		if (valor >1) {
    			repetidos++;
    		}
    	}
