...
public class SandboxMapas
{
    ...
    public Collection<String> getLlaves( )
    {
    	...
    	for(String cadena:listallaves) {
    		llavesMayusculas.add(cadena.toUpperCase());
    	}
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	StringBuilder sbinvertida= new StringBuilder(cadena);
    	String invertida = sbinvertida.reverse().toString();
    ...
    {
    	Collection<String> llaves=getLlaves();
    	List<String> listavalores=new ArrayList<>(mapaCadenas.values());
    	mapaCadenas.clear();
    	int i=0;
    	for (String llave:llaves) {
    		mapaCadenas.put(llave, listavalores.get(i++));
    	}
