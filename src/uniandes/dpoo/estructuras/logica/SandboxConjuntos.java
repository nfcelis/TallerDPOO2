...
public class SandboxConjuntos
{
    ...
    {
    	List<String> ordenados= new ArrayList<>(arbolCadenas);
        return ordenados;
    }
    ...
    {
    	List<String> ordenados= getCadenasComoLista();
    ...
    {
    	Collection<String> mayoresa= new ArrayList<>();
    	
    	for(String valorcadena:arbolCadenas) {
    		if (valorcadena.compareTo(cadena)>=0) {
    			mayoresa.add(valorcadena);
    		}
    	}
        return mayoresa;
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
        ...
        while (iterator.hasNext()) {
            String valorcadena = iterator.next();
            if (valorcadena.equalsIgnoreCase(cadena)) {
                iterator.remove();
            }
        }
    ...
    public void volverMayusculas( )
    {
    	...
    	for(String cadena:arbolCadenas) {
    		Mayusculas.add(cadena.toUpperCase());
